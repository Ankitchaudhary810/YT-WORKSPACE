            ...
            <ul className="flex justify-center gap-6 sm:justify-end">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-slate-500 transition hover:text-slate-700/75 dark:text-slate-500 dark:hover:text-slate-500/75"
                >
              ...
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-slate-700 transition hover:text-slate-700/75 dark:text-slate-500 dark:hover:text-slate-500/75"
                >
